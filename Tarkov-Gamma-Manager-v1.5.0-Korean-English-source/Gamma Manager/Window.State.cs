...
namespace Gamma_Manager
{
    ...
    public partial class Window : Form
    {
        ...
        ComboBox comboBoxImageSelect; // 콤보박스로 변경됨
        ...
        // Physical-monitor writes are serialized so rapid hotkeys cannot overlap.
        // A waiting worker re-checks the generation before touching the monitor,
        // ensuring only the newest requested profile is actually written.
        private readonly object physicalMonitorApplyLock = new object();
