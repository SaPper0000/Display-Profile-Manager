...
namespace Gamma_Manager
{
    internal sealed class ProfileManagerForm : Form
    {
        ...
        private void ExportProfile()
        {
            ...
            string raw = string.Join("|", "TGM-Profile", "v1.5.4", EscapeField(p),
        ...
        private void ImportProfile()
        {
            ...
            try
            {
                ...
                bool isV154 = string.Equals(parts[1], "v1.5.4", StringComparison.OrdinalIgnoreCase);
                bool isV1532 = !isV154 && string.Equals(parts[1], "v1.5.3-2", StringComparison.OrdinalIgnoreCase);
                bool isV153 = !isV154 && !isV1532 && string.Equals(parts[1], "v1.5.3", StringComparison.OrdinalIgnoreCase);

                if ((isV154 || isV1532) && parts.Length < 18)
                ...
                int offset = (isV154 || isV1532) ? 2 : (isV153 ? 1 : 0);
