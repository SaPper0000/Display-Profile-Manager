...
namespace Gamma_Manager
{
    public partial class Window : Form
    {
        ...
        private void ApplyLanguage()
        {
            ...
            Text = "Tarkov Gamma Manager v1.5.2";
            notifyIcon.Text = "Tarkov Gamma Manager v1.5.2";
        ...
        private void SetupModernLayout()
        {
            ...
            Text = "Tarkov Gamma Manager v1.5.2";
            Controls.Clear(); this.ClientSize = new Size(1080, 720);

            appTitle = CreateLabel("TARKOV GAMMA", new Font("Segoe UI", 24f, FontStyle.Bold), 28, 12, 520, 44);
            ...
            imageCaption = CreateLabel("ESCAPE FROM TARKOV", new Font("Segoe UI", 12.5f, FontStyle.Bold), 18, 244, 304, 32);
            ...
            // 4. OSD 팝업 알림 설정 버튼 (멤버 변수에 직접 할당)
            ...
            // 창 크기 강제 설정 및 하단 여백 확보
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            this.ClientSize = new Size(1080, 720);
            this.MaximumSize = new Size(1110, 760);
