    ...
    public partial class Window : Form
    {
        private void buttonBackup_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog dialog = new SaveFileDialog())
            {
                ...
                // 예: Tarkov-Gamma-Manager-Backup-20260826-035400.ini 형식으로 생성
                dialog.FileName = $"Tarkov-Gamma-Manager-Backup-{DateTime.Now:yyyyMMdd-HHmmss}.ini";
        ...
        private async void buttonUpdateCheck_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (WebClient client = new WebClient())
                {
                    ...
                    Version currentVersion = System.Reflection.Assembly.GetExecutingAssembly().GetName().Version ?? new Version("1.5.2.0");
