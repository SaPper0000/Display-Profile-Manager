        ...
        private static bool EnsureWmiInstances()
        {
            lock (Sync)
            {
                ...
                try
                {
                    ...
                    {
                        foreach (ManagementObject o in reads) { readInstance = new ManagementObject(o.Path); break; }
                    }
                    ...
                    {
                        foreach (ManagementObject o in writes) { writeInstance = new ManagementObject(o.Path); break; }
                    }
                }
                catch (Exception ex)
                {
