...
namespace Gamma_Manager
{
    public partial class Window : Form
    {
        ...
        public Window()
        {
            ...
            initPresets();
            this.Text = "Tarkov Gamma Manager v1.4.3 " + (LanguageManager.Korean ? "Korean" : "English");
        ...
        private void ApplyLanguage()
        {
            ...
            Text = "Tarkov Gamma Manager v1.4.3 " + (LanguageManager.Korean ? "Korean" : "English");
            notifyIcon.Text = "Tarkov Gamma Manager v1.4.3 " + (LanguageManager.Korean ? "Korean" : "English");
