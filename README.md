...
이 프로젝트는 공개된 Gamma Manager 프로젝트를 기반으로
수정 및 확장되었습니다.
...
원본 프로젝트는 CC0 1.0 라이선스로 공개되어 있습니다.

본 프로젝트에서는 원본을 기반으로 다음과 같은 기능을
추가 및 수정했습니다.
...
이 프로젝트의 개발 및 유지보수 과정에서
OpenAI ChatGPT를 개발 보조 도구로 활용했습니다.

기능 설계, 코드 수정, 디버깅, 리팩터링 및 문서 작성 등에
AI의 도움을 받았습니다.

⚠️ 주의사항

이 프로그램은 Battlestate Games 또는 Escape from Tarkov의
공식 프로그램이 아닙니다.

Escape from Tarkov 및 관련 상표의 권리는 해당 권리자에게 있습니다.

프로그램 사용으로 발생할 수 있는 게임 이용 제한,
설정 손실 또는 기타 문제에 대해서는 개발자가 책임지지 않습니다.

📄 라이선스

원본 프로젝트는 CC0 1.0 라이선스로 공개되어 있습니다.

자세한 내용은 LICENSE.txt를 확인하십시오.
