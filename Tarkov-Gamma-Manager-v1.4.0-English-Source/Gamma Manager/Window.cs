...
namespace Gamma_Manager
{
    public partial class Window : Form
    {
        ...
        string manualSelectionPreset = null;
        Label appTitle;
        Label appSubtitle;
        ...
        private void SetupGameAutoTimer()
        {
            gameAutoTimer = new Timer();
            gameAutoTimer.Interval = 350;
            gameAutoTimer.Tick += GameAutoTimer_Tick;
            gameAutoTimer.Start();
        }
        ...
        private void GameAutoTimer_Tick(object sender, EventArgs e)
        {
            if (applyingPreset || displays == null || displays.Count == 0) return;
        ...
        private void RefreshGlobalHotkeys()
        {
            ...
            foreach (string preset in presets)
            {
                ...
                hotkey.Pressed += delegate
                {
                    ...
                    if (isToggle && manualToggleActive &&
                        string.Equals(manualTogglePreset, capturedPreset, StringComparison.Ordinal))
                    {
                        // Toggle off: return to the exact profile that was active before
                        // this toggle hotkey was pressed. In a Game Auto session this is
                        // normally the automatically selected profile.
                        string returnPreset = manualToggleReturnPreset;
                        manualToggleActive = false;
                        manualTogglePreset = null;
                        manualToggleReturnPreset = null;
                        manualOverrideActive = false;
                        ...
                        if (!string.IsNullOrEmpty(returnPreset))
                        {
                            ...
                            activeAutoPreset = returnPreset;
                            visiblePreset = returnPreset;
                        }
                        else if (hasGameMapping)
                        {
                            ApplyPreset(mapped, true, mappedMonitor);
                            activeAutoPreset = mapped;
                            visiblePreset = mapped;
                        }
                    }
                    else
                    {
                        ...
                        if (isToggle)
                        {
                            // Prefer the active Game Auto profile. Otherwise use the
                            // currently selected profile on the main screen.
                            previousPreset = !string.IsNullOrEmpty(activeAutoPreset)
                                ? activeAutoPreset
                                : (comboBoxPresets.SelectedItem as string);
                        ...
                        {
                            // A normal Apply hotkey cancels any active toggle state.
                            manualToggleActive = false;
                            manualTogglePreset = null;
                            manualToggleReturnPreset = null;
                        }
                        ...
                        activeAutoPreset = capturedPreset;
                    }
        ...
        private void ApplyLanguage()
        {
            ...
            Text = "Tarkov Gamma manager V1.4";
            notifyIcon.Text = "Tarkov Gamma manager V1.4";
            ...
            labelMonitorBrightnessUp.Text = ko ? "모니터" : "Monitor";
            labelMonitorBrightnessDown.Text = ko ? "밝기" : "Brightness";
            labelMonitorContrastUp.Text = ko ? "모니터" : "Monitor";
            labelMonitorContrastDown.Text = ko ? "대비" : "Contrast";
        ...
        private void SetupModernLayout()
        {
            ...
            appSubtitle.Text = "디스플레이 프로필 및 색상 조절";
            ...
            gpuCard.Size = new Size(620, 180);
            gpuCard.BorderStyle = BorderStyle.FixedSingle;
            gpuCard.SendToBack();

            monitorCard = new Panel();
            monitorCard.Location = new Point(18, 405);
            ...
            rightCard.Size = new Size(360, 530);
            ...
            labelGamma.Location = new Point(35, 212);
            labelBrightness.Location = new Point(35, 262);
            labelContrast.Location = new Point(35, 312);
            ...
            labelMonitorBrightnessUp.Location = new Point(35, 428);
            labelMonitorBrightnessDown.Location = new Point(35, 447);
            trackBarMonitorBrightness.Location = new Point(125, 415);
            trackBarMonitorBrightness.Size = new Size(315, 45);
            textBoxMonitorBrightness.Location = new Point(450, 426);
            textBoxMonitorBrightness.Size = new Size(52, 23);

            labelMonitorContrastUp.Location = new Point(35, 468);
            labelMonitorContrastDown.Location = new Point(35, 487);
            trackBarMonitorContrast.Location = new Point(125, 455);
            trackBarMonitorContrast.Size = new Size(315, 45);
            textBoxMonitorContrast.Location = new Point(450, 466);
            textBoxMonitorContrast.Size = new Size(52, 23);

            buttonReset.Location = new Point(520, 414);
            buttonReset.Size = new Size(109, 30);
            buttonHide.Location = new Point(520, 451);
